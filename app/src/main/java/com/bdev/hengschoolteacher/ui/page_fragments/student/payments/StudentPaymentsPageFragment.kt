...
@AndroidEntryPoint
class StudentPaymentsPageFragment : BasePageFragment<StudentPaymentsPageFragmentViewModel>() {
    private val args: StudentPaymentsPageFragmentArgs by navArgs()
    ...
    override fun provideViewModel(): StudentPaymentsPageFragmentViewModel =
        ViewModelProvider(this).get(StudentPaymentsPageFragmentViewModelImpl::class.java)
    ...
    override fun doOnViewCreated() {
        ...
        studentPaymentsSecondaryHeaderView.bind(
            data = StudentHeaderFragmentData(
                ...
                item = StudentHeaderFragmentItem.PAYMENTS
            ),
            navCommandHandler = {}
        )
        ...
        studentPaymentsListAdapter.setItems(
                studentsPaymentsProviderInteractor
                        .getForStudent(studentLogin = args.args.login)
