...
@AndroidEntryPoint
class MonitoringStudentPageFragment : BasePageFragment<MonitoringStudentPageFragmentViewModel>() {
    companion object {
    ...
    override fun provideViewModel(): MonitoringStudentPageFragmentViewModel =
